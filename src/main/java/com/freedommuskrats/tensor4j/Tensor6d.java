...
public class Tensor6d extends DfData {
                        ...
                        for (int x2 = 0; x2 < data[0][0][0][0].length; x2++) {
                            for (int x1 = 0; x1 < data[0][0][0][0][0].length; x1++) {
                                if (x6 < data.length) {
                                    ...
                                    newData[x6][x5][x4][x3][x2][x1] = ap[x5][x4][x3][x2][x1];
                                }
                            }
                        }
                    }
     ...
     * @return
     */
    public static Tensor6d multiply(Tensor6d tensor, double scalar) {
        double[][][][][][] data = tensor.getData();
        double[][][][][][] newData = new double[data.length][data[0].length][data[0][0].length][data[0][0][0].length][data[0][0][0][0].length][data[0][0][0][0][0].length];
            ...
            for (int x5 = 0; x5 < data[0].length; x5++) {
                for (int x4 = 0; x4 < data[0][0].length; x4++) {
                    for (int x3 = 0; x3 < data[0][0][0].length; x3++) {
                        for (int x2 = 0; x2 < data[0][0][0][0].length; x2++) {
                            for (int x1 = 0; x1 < data[0][0][0][0][0].length; x1++) {
                                newData[x6][x5][x4][x3][x2][x1] = data[x6][x5][x4][x3][x2][x1] * scalar;
                            }
                        }
                    }
                }
    ...
    private static void verifyDimensions(double[][][][][] array, int[]expectedDimensions) {
        if (array.length != expectedDimensions[0]) {
            throw new DataException(
                    String.format("Size of dimension 4 of array must be %s, but was %s", expectedDimensions[0], array.length)
            );
        }
        else if (array[0].length != expectedDimensions[1]) {
            throw new DataException(
                    String.format("Size of dimension 3 of array must be %s, but was %s", expectedDimensions[1], array[0].length)
            );
        }
        else if (array[0][0].length != expectedDimensions[2]) {
            throw new DataException(
                    String.format("Size of dimension 2 of array must be %s, but was %s", expectedDimensions[2], array[0][0].length)
            );
        }
        else if (array[0][0][0].length != expectedDimensions[3]) {
            throw new DataException(
                    String.format("Size of dimension 1 of array must be %s, but was %s", expectedDimensions[3], array[0][0][0].length)
            );
        }
        else if (array[0][0][0][0].length != expectedDimensions[4]) {
            throw new DataException(
                    String.format("Size of dimension 0 of array must be %s, but was %s", expectedDimensions[4], array[0][0][0][0].length)
            );
        }
    }
    ...
    public Tensor5d squeeze(int dim) {
        ...
        double[][][][][] newData = new double[newShape[4]][newShape[3]][newShape[2]][newShape[1]][newShape[0]];
            ...
            for (int x2 = 0; x2 < data[0][0][0][0].length; x2++) {
                for (int x3 = 0; x3 < data[0][0][0].length; x3++) {
                    for (int x4 = 0; x4 < data[0][0].length; x4++) {
                        for (int x5 = 0; x5 < data[0].length; x5++) {
                            for (int x6 = 0; x6 < data.length; x6++) {
                                double val = data[x6][x5][x4][x3][x2][x1];
                                if (val > max) {
                                    max = val;
                                }
                            }
                ...
                for (int x4 = 0; x4 < data[0][0].length; x4++) {
                    ...
                    for (int x3 = 0; x3 < data[0][0][0].length; x3++) {
                        ...
                        for (int x2 = 0; x2 < data[0][0][0][0].length; x2++) {
                            ...
                            sb.append("    [");
                            for (int x1 = 0; x1 < data[0][0][0][0][0].length; x1++) {
                                sb.append(roundPrint(data[x6][x5][x4][x3][x2][x1], PRECISION, spacing));
