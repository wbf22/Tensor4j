...
public class Tensor9d extends DfData {
     ...
     * @return
     */
    public static Tensor9d multiply(Tensor9d array, double scalar) {
                        ...
                        for (int x5 = 0; x5 < data[0][0][0][0].length; x5++) {
                            for (int x4 = 0; x4 < data[0][0][0][0][0].length; x4++) {
                                for (int x3 = 0; x3 < data[0][0][0][0][0][0].length; x3++) {
                                    for (int x2 = 0; x2 < data[0][0][0][0][0][0][0].length; x2++) {
                                        for (int x1 = 0; x1 < data[0][0][0][0][0][0][0][0].length; x1++) {
                                            data[x9][x8][x7][x6][x5][x4][x3][x2][x1] *= scalar;
                                        }
                                    }
                                }
                            }
    ...
    public Tensor8d squeeze(int dim) {
        ...
        double[][][][][][][][] newData = new double[newShape[8]][newShape[7]][newShape[6]][newShape[5]][newShape[4]][newShape[3]][newShape[2]][newShape[1]];
                            ...
                            for (int x4 = 0; x4 < data[0][0][0][0][0].length; x4++) {
                                ...
                                for (int x3 = 0; x3 < data[0][0][0][0][0][0].length; x3++) {
                                    ...
                                    for (int x2 = 0; x2 < data[0][0][0][0][0][0][0].length; x2++) {
                                        ...
                                        sb.append("       [");
                                        for (int x1 = 0; x1 < data[0][0][0][0][0][0][0][0].length; x1++) {
                                            sb.append(roundPrint(data[x9][x8][x7][x6][x5][x4][x3][x2][x1], 4));
